...
typedef void         (* GstCVObjectInfoMapFunc)                        (guint             index,
                                                                        GstCVObjectInfo * info,
                                                                        gpointer          user_data);

GType                gst_cv_object_info_map_get_type                   (void);

GstCVObjectInfoMap * gst_cv_object_info_map_new                        (void);

GstCVObjectInfo *    gst_cv_object_info_map_lookup_object_info         (GstCVObjectInfoMap * self,
                                                                        guint                index,
                                                                        const gchar *        target_element_name,
